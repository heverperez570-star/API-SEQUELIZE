...
const internalServerErrorResponse = (res, message= ReasonPhrases.INTERNAL_SERVER_ERROR)=>{
...
module.exports={forbiddenResponse,unauthorizedResponse,
    notFoundResponse,badRequestResponse, conflictResponse,internalServerErrorResponse };